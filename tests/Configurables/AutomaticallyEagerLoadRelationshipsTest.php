...
use IvanFuhr\Essentials\Configurables\AutomaticallyEagerLoadRelationships;
...
it('can be disabled via configuration', function (): void {
    config()->set('essentials.configurables.'.AutomaticallyEagerLoadRelationships::class, false);
