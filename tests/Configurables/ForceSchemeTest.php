...
use IvanFuhr\Essentials\Configurables\ForceScheme;
...
it('can be disabled via configuration', function (): void {
    config()->set('essentials.configurables.'.ForceScheme::class, false);
...
it('environments to be forced can be set via configuration', function (): void {
    config()->set('essentials.configurables.environments.'.ForceScheme::class, ['local', 'testing']);
